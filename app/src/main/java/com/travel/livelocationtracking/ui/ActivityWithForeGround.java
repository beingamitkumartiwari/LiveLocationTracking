...
import com.travel.livelocationtracking.Utils;
import com.travel.livelocationtracking.services.LocationUpdateService;

public class ActivityWithForeGround extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_with_fore_ground);
        ...
        if (shouldProvideRationale) {
            ...
            Snackbar.make(
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(ActivityWithForeGround.this,
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (location != null) {
                Toast.makeText(ActivityWithForeGround.this, Utils.getLocationText(location),
